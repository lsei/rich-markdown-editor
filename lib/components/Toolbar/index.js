...
var Toolbar = function (_React$Component) {
  ...
  function Toolbar() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Toolbar.__proto__ || Object.getPrototypeOf(Toolbar)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      _this.updateIfPropsChanged(prevProps);
    }, _this.updateIfPropsChanged = (0, _debounce3.default)(function (prevProps) {
      if (!(0, _isEqual3.default)(_this.props, prevProps)) {
        _this.update();
      }
    }, 100, { leading: true, trailing: true }), _this.hideLinkToolbar = function () {
